...
interface IAMUploadFormProps {
    onAnalyze: (policy: any, options?: AnalyzeOptions) => void
    disabled?: boolean
}
                    ...
                    <div className="space-y-3">
                        <label className="flex items-center justify-between cursor-pointer group">
                            <div>
                                ...
                                <p className="text-xs text-slate-500">Flag actions not authorized for Moderate</p>
                            </div>
                            <div
                        ...
                        <label className="flex items-center justify-between cursor-pointer group">
                            <div>
                                ...
                                <p className="text-xs text-slate-500">Flag actions not authorized for High (GovCloud)</p>
                            </div>
                            <div
