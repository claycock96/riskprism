...
class RiskEngine:
    ...
    def _rule_sg_ingress_wide_cidr(
        self,
        change: Dict[str, Any],
        plan_json: Dict[str, Any]
    ) -> Optional[RiskFinding]:
    ...
    def _rule_tgw_attach_unrestricted(
        self,
        change: Dict[str, Any],
        plan_json: Dict[str, Any]
    ) -> Optional[RiskFinding]:
    ...
    def _rule_kms_key_rotation_off(
        self,
        change: Dict[str, Any],
        plan_json: Dict[str, Any]
    ) -> Optional[RiskFinding]:
    ...
    def _rule_kms_policy_open_account(
        self,
        change: Dict[str, Any],
        plan_json: Dict[str, Any]
    ) -> Optional[RiskFinding]:
    ...
    def _rule_ecr_scan_on_push_off(
        self,
        change: Dict[str, Any],
        plan_json: Dict[str, Any]
    ) -> Optional[RiskFinding]:
    ...
    def _rule_rds_deletion_protection_off(
        ...
        if after.get('deletion_protection') is False:
            ...
            return RiskFinding(
                ...
                resource_ref=self._hash_resource_ref(change.get('address', '')),
                evidence={"deletion_protection": False, "switched_off": (before and before.get('deletion_protection') is True)},
    ...
    def _rule_rds_backup_retention_low(
        self,
        change: Dict[str, Any],
        plan_json: Dict[str, Any]
    ) -> Optional[RiskFinding]:
    ...
    def _rule_rds_public_snapshots(
        self,
        change: Dict[str, Any],
        plan_json: Dict[str, Any]
    ) -> Optional[RiskFinding]:
    ...
    def _rule_s3_force_destroy_true(
        self,
        change: Dict[str, Any],
        plan_json: Dict[str, Any]
    ) -> Optional[RiskFinding]:
    ...
    def _rule_ec2_public_ip_assigned(
        self,
        change: Dict[str, Any],
        plan_json: Dict[str, Any]
    ) -> Optional[RiskFinding]:
    ...
    def _rule_lambda_url_auth_none(
        self,
        change: Dict[str, Any],
        plan_json: Dict[str, Any]
    ) -> Optional[RiskFinding]:
